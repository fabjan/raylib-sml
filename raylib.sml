...
(* val DrawTextureV: raylib_texture -> UNKNOWN[Vector2] -> int -> unit = app3 (dlsym dlh "raylib_DrawTextureV") *)
(* val DrawTextureEx: raylib_texture -> UNKNOWN[Vector2] -> real -> real -> int -> unit = app5 (dlsym dlh "raylib_DrawTextureEx") *)
(* val DrawTextureRec: raylib_texture -> UNKNOWN[Rectangle] -> UNKNOWN[Vector2] -> int -> unit = app4 (dlsym dlh "raylib_DrawTextureRec") *)
(* val DrawTexturePro: raylib_texture -> UNKNOWN[Rectangle] -> UNKNOWN[Rectangle] -> UNKNOWN[Vector2] -> real -> int -> unit = app6 (dlsym dlh "raylib_DrawTexturePro") *)
(* val DrawTextureNPatch: raylib_texture -> UNKNOWN[NPatchInfo] -> UNKNOWN[Rectangle] -> UNKNOWN[Vector2] -> real -> int -> unit = app6 (dlsym dlh "raylib_DrawTextureNPatch") *)
...
(* val DrawBillboardRec: UNKNOWN[Camera] -> raylib_texture -> UNKNOWN[Rectangle] -> UNKNOWN[Vector3] -> UNKNOWN[Vector2] -> int -> unit = app6 (dlsym dlh "raylib_DrawBillboardRec") *)
(* val DrawBillboardPro: UNKNOWN[Camera] -> raylib_texture -> UNKNOWN[Rectangle] -> UNKNOWN[Vector3] -> UNKNOWN[Vector3] -> UNKNOWN[Vector2] -> UNKNOWN[Vector2] -> real -> int -> unit = app9 (dlsym dlh "raylib_DrawBillboardPro") *)
