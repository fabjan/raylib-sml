...
(* val SetShaderValueTexture: UNKNOWN[Shader] -> int -> raylib_texture -> unit = app3 (dlsym dlh "raylib_SetShaderValueTexture") *)
(* val UnloadShader: UNKNOWN[Shader] -> unit = app1 (dlsym dlh "raylib_UnloadShader") *)
(* val GetScreenToWorldRay: raylib_vector2 -> UNKNOWN[Camera] -> UNKNOWN[Ray] = app2 (dlsym dlh "raylib_GetScreenToWorldRay") *)
(* val GetScreenToWorldRayEx: raylib_vector2 -> UNKNOWN[Camera] -> int -> int -> UNKNOWN[Ray] = app4 (dlsym dlh "raylib_GetScreenToWorldRayEx") *)
(* val GetWorldToScreen: UNKNOWN[Vector3] -> UNKNOWN[Camera] -> raylib_vector2 = app2 (dlsym dlh "raylib_GetWorldToScreen") *)
(* val GetWorldToScreenEx: UNKNOWN[Vector3] -> UNKNOWN[Camera] -> int -> int -> raylib_vector2 = app4 (dlsym dlh "raylib_GetWorldToScreenEx") *)
(* val GetWorldToScreen2D: raylib_vector2 -> UNKNOWN[Camera2D] -> raylib_vector2 = app2 (dlsym dlh "raylib_GetWorldToScreen2D") *)
(* val GetScreenToWorld2D: raylib_vector2 -> UNKNOWN[Camera2D] -> raylib_vector2 = app2 (dlsym dlh "raylib_GetScreenToWorld2D") *)
...
(* val SetShapesTexture: raylib_texture -> UNKNOWN[Rectangle] -> unit = app2 (dlsym dlh "raylib_SetShapesTexture") *)
...
val DrawPixelV: raylib_vector2 -> int -> unit = app2 (dlsym dlh "raylib_DrawPixelV")
val DrawLine: int -> int -> int -> int -> int -> unit = app5 (dlsym dlh "raylib_DrawLine")
val DrawLineV: raylib_vector2 -> raylib_vector2 -> int -> unit = app3 (dlsym dlh "raylib_DrawLineV")
val DrawLineEx: raylib_vector2 -> raylib_vector2 -> real -> int -> unit = app4 (dlsym dlh "raylib_DrawLineEx")
(* val DrawLineStrip: UNKNOWN[const Vector2 *] -> int -> int -> unit = app3 (dlsym dlh "raylib_DrawLineStrip") *)
val DrawLineBezier: raylib_vector2 -> raylib_vector2 -> real -> int -> unit = app4 (dlsym dlh "raylib_DrawLineBezier")
val DrawCircle: int -> int -> real -> int -> unit = app4 (dlsym dlh "raylib_DrawCircle")
(* val DrawCircleSector: raylib_vector2 -> real -> real -> real -> int -> int -> unit = app6 (dlsym dlh "raylib_DrawCircleSector") *)
(* val DrawCircleSectorLines: raylib_vector2 -> real -> real -> real -> int -> int -> unit = app6 (dlsym dlh "raylib_DrawCircleSectorLines") *)
val DrawCircleGradient: int -> int -> real -> int -> int -> unit = app5 (dlsym dlh "raylib_DrawCircleGradient")
val DrawCircleV: raylib_vector2 -> real -> int -> unit = app3 (dlsym dlh "raylib_DrawCircleV")
val DrawCircleLines: int -> int -> real -> int -> unit = app4 (dlsym dlh "raylib_DrawCircleLines")
val DrawCircleLinesV: raylib_vector2 -> real -> int -> unit = app3 (dlsym dlh "raylib_DrawCircleLinesV")
...
(* val DrawRing: raylib_vector2 -> real -> real -> real -> real -> int -> int -> unit = app7 (dlsym dlh "raylib_DrawRing") *)
(* val DrawRingLines: raylib_vector2 -> real -> real -> real -> real -> int -> int -> unit = app7 (dlsym dlh "raylib_DrawRingLines") *)
val DrawRectangle: int -> int -> int -> int -> int -> unit = app5 (dlsym dlh "raylib_DrawRectangle")
val DrawRectangleV: raylib_vector2 -> raylib_vector2 -> int -> unit = app3 (dlsym dlh "raylib_DrawRectangleV")
(* val DrawRectangleRec: UNKNOWN[Rectangle] -> int -> unit = app2 (dlsym dlh "raylib_DrawRectangleRec") *)
(* val DrawRectanglePro: UNKNOWN[Rectangle] -> raylib_vector2 -> real -> int -> unit = app4 (dlsym dlh "raylib_DrawRectanglePro") *)
...
val DrawTriangle: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> int -> unit = app4 (dlsym dlh "raylib_DrawTriangle")
val DrawTriangleLines: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> int -> unit = app4 (dlsym dlh "raylib_DrawTriangleLines")
...
val DrawPoly: raylib_vector2 -> int -> real -> real -> int -> unit = app5 (dlsym dlh "raylib_DrawPoly")
val DrawPolyLines: raylib_vector2 -> int -> real -> real -> int -> unit = app5 (dlsym dlh "raylib_DrawPolyLines")
(* val DrawPolyLinesEx: raylib_vector2 -> int -> real -> real -> real -> int -> unit = app6 (dlsym dlh "raylib_DrawPolyLinesEx") *)
...
val DrawSplineSegmentLinear: raylib_vector2 -> raylib_vector2 -> real -> int -> unit = app4 (dlsym dlh "raylib_DrawSplineSegmentLinear")
(* val DrawSplineSegmentBasis: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> real -> int -> unit = app6 (dlsym dlh "raylib_DrawSplineSegmentBasis") *)
(* val DrawSplineSegmentCatmullRom: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> real -> int -> unit = app6 (dlsym dlh "raylib_DrawSplineSegmentCatmullRom") *)
val DrawSplineSegmentBezierQuadratic: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> real -> int -> unit = app5 (dlsym dlh "raylib_DrawSplineSegmentBezierQuadratic")
(* val DrawSplineSegmentBezierCubic: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> real -> int -> unit = app6 (dlsym dlh "raylib_DrawSplineSegmentBezierCubic") *)
val GetSplinePointLinear: raylib_vector2 -> raylib_vector2 -> real -> raylib_vector2 = app3 (dlsym dlh "raylib_GetSplinePointLinear")
val GetSplinePointBasis: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> real -> raylib_vector2 = app5 (dlsym dlh "raylib_GetSplinePointBasis")
val GetSplinePointCatmullRom: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> real -> raylib_vector2 = app5 (dlsym dlh "raylib_GetSplinePointCatmullRom")
val GetSplinePointBezierQuad: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> real -> raylib_vector2 = app4 (dlsym dlh "raylib_GetSplinePointBezierQuad")
val GetSplinePointBezierCubic: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> real -> raylib_vector2 = app5 (dlsym dlh "raylib_GetSplinePointBezierCubic")
(* val CheckCollisionRecs: UNKNOWN[Rectangle] -> UNKNOWN[Rectangle] -> bool = app2 (dlsym dlh "raylib_CheckCollisionRecs") *)
val CheckCollisionCircles: raylib_vector2 -> real -> raylib_vector2 -> real -> bool = app4 (dlsym dlh "raylib_CheckCollisionCircles")
(* val CheckCollisionCircleRec: raylib_vector2 -> real -> UNKNOWN[Rectangle] -> bool = app3 (dlsym dlh "raylib_CheckCollisionCircleRec") *)
val CheckCollisionCircleLine: raylib_vector2 -> real -> raylib_vector2 -> raylib_vector2 -> bool = app4 (dlsym dlh "raylib_CheckCollisionCircleLine")
(* val CheckCollisionPointRec: raylib_vector2 -> UNKNOWN[Rectangle] -> bool = app2 (dlsym dlh "raylib_CheckCollisionPointRec") *)
val CheckCollisionPointCircle: raylib_vector2 -> raylib_vector2 -> real -> bool = app3 (dlsym dlh "raylib_CheckCollisionPointCircle")
val CheckCollisionPointTriangle: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> bool = app4 (dlsym dlh "raylib_CheckCollisionPointTriangle")
val CheckCollisionPointLine: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> int -> bool = app4 (dlsym dlh "raylib_CheckCollisionPointLine")
(* val CheckCollisionPointPoly: raylib_vector2 -> UNKNOWN[const Vector2 *] -> int -> bool = app3 (dlsym dlh "raylib_CheckCollisionPointPoly") *)
(* val CheckCollisionLines: raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> UNKNOWN[Vector2 *] -> bool = app5 (dlsym dlh "raylib_CheckCollisionLines") *)
...
val LoadImageRaw: string -> int -> int -> int -> int -> raylib_image = app5 (dlsym dlh "raylib_LoadImageRaw")
(* val LoadImageAnim: string -> UNKNOWN[int *] -> raylib_image = app2 (dlsym dlh "raylib_LoadImageAnim") *)
(* val LoadImageAnimFromMemory: string -> UNKNOWN[const unsigned char *] -> int -> UNKNOWN[int *] -> raylib_image = app4 (dlsym dlh "raylib_LoadImageAnimFromMemory") *)
(* val LoadImageFromMemory: string -> UNKNOWN[const unsigned char *] -> int -> raylib_image = app3 (dlsym dlh "raylib_LoadImageFromMemory") *)
...
val ExportImage: raylib_image -> string -> bool = app2 (dlsym dlh "raylib_ExportImage")
(* val ExportImageToMemory: raylib_image -> string -> UNKNOWN[int *] -> UNKNOWN[unsigned char *] = app3 (dlsym dlh "raylib_ExportImageToMemory") *)
val ExportImageAsCode: raylib_image -> string -> bool = app2 (dlsym dlh "raylib_ExportImageAsCode")
val GenImageColor: int -> int -> int -> raylib_image = app3 (dlsym dlh "raylib_GenImageColor")
val GenImageGradientLinear: int -> int -> int -> int -> int -> raylib_image = app5 (dlsym dlh "raylib_GenImageGradientLinear")
val GenImageGradientRadial: int -> int -> real -> int -> int -> raylib_image = app5 (dlsym dlh "raylib_GenImageGradientRadial")
val GenImageGradientSquare: int -> int -> real -> int -> int -> raylib_image = app5 (dlsym dlh "raylib_GenImageGradientSquare")
(* val GenImageChecked: int -> int -> int -> int -> int -> int -> raylib_image = app6 (dlsym dlh "raylib_GenImageChecked") *)
val GenImageWhiteNoise: int -> int -> real -> raylib_image = app3 (dlsym dlh "raylib_GenImageWhiteNoise")
val GenImagePerlinNoise: int -> int -> int -> int -> real -> raylib_image = app5 (dlsym dlh "raylib_GenImagePerlinNoise")
val GenImageCellular: int -> int -> int -> raylib_image = app3 (dlsym dlh "raylib_GenImageCellular")
val GenImageText: int -> int -> string -> raylib_image = app3 (dlsym dlh "raylib_GenImageText")
val ImageCopy: raylib_image -> raylib_image = app1 (dlsym dlh "raylib_ImageCopy")
(* val ImageFromImage: raylib_image -> UNKNOWN[Rectangle] -> raylib_image = app2 (dlsym dlh "raylib_ImageFromImage") *)
val ImageFromChannel: raylib_image -> int -> raylib_image = app2 (dlsym dlh "raylib_ImageFromChannel")
val ImageText: string -> int -> int -> raylib_image = app3 (dlsym dlh "raylib_ImageText")
(* val ImageTextEx: UNKNOWN[Font] -> string -> real -> real -> int -> raylib_image = app5 (dlsym dlh "raylib_ImageTextEx") *)
...
(* val ImageAlphaMask: UNKNOWN[Image *] -> raylib_image -> unit = app2 (dlsym dlh "raylib_ImageAlphaMask") *)
...
(* val LoadImagePalette: raylib_image -> int -> UNKNOWN[int *] -> UNKNOWN[Color *] = app3 (dlsym dlh "raylib_LoadImagePalette") *)
...
(* val GetImageAlphaBorder: raylib_image -> real -> UNKNOWN[Rectangle] = app2 (dlsym dlh "raylib_GetImageAlphaBorder") *)
val GetImageColor: raylib_image -> int -> int -> int = app3 (dlsym dlh "raylib_GetImageColor")
...
(* val ImageDrawPixelV: UNKNOWN[Image *] -> raylib_vector2 -> int -> unit = app3 (dlsym dlh "raylib_ImageDrawPixelV") *)
(* val ImageDrawLine: UNKNOWN[Image *] -> int -> int -> int -> int -> int -> unit = app6 (dlsym dlh "raylib_ImageDrawLine") *)
(* val ImageDrawLineV: UNKNOWN[Image *] -> raylib_vector2 -> raylib_vector2 -> int -> unit = app4 (dlsym dlh "raylib_ImageDrawLineV") *)
(* val ImageDrawLineEx: UNKNOWN[Image *] -> raylib_vector2 -> raylib_vector2 -> int -> int -> unit = app5 (dlsym dlh "raylib_ImageDrawLineEx") *)
(* val ImageDrawCircle: UNKNOWN[Image *] -> int -> int -> int -> int -> unit = app5 (dlsym dlh "raylib_ImageDrawCircle") *)
(* val ImageDrawCircleV: UNKNOWN[Image *] -> raylib_vector2 -> int -> int -> unit = app4 (dlsym dlh "raylib_ImageDrawCircleV") *)
(* val ImageDrawCircleLines: UNKNOWN[Image *] -> int -> int -> int -> int -> unit = app5 (dlsym dlh "raylib_ImageDrawCircleLines") *)
(* val ImageDrawCircleLinesV: UNKNOWN[Image *] -> raylib_vector2 -> int -> int -> unit = app4 (dlsym dlh "raylib_ImageDrawCircleLinesV") *)
(* val ImageDrawRectangle: UNKNOWN[Image *] -> int -> int -> int -> int -> int -> unit = app6 (dlsym dlh "raylib_ImageDrawRectangle") *)
(* val ImageDrawRectangleV: UNKNOWN[Image *] -> raylib_vector2 -> raylib_vector2 -> int -> unit = app4 (dlsym dlh "raylib_ImageDrawRectangleV") *)
...
(* val ImageDrawTriangle: UNKNOWN[Image *] -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> int -> unit = app5 (dlsym dlh "raylib_ImageDrawTriangle") *)
(* val ImageDrawTriangleEx: UNKNOWN[Image *] -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> int -> int -> int -> unit = app7 (dlsym dlh "raylib_ImageDrawTriangleEx") *)
(* val ImageDrawTriangleLines: UNKNOWN[Image *] -> raylib_vector2 -> raylib_vector2 -> raylib_vector2 -> int -> unit = app5 (dlsym dlh "raylib_ImageDrawTriangleLines") *)
...
(* val ImageDraw: UNKNOWN[Image *] -> raylib_image -> UNKNOWN[Rectangle] -> UNKNOWN[Rectangle] -> int -> unit = app5 (dlsym dlh "raylib_ImageDraw") *)
(* val ImageDrawText: UNKNOWN[Image *] -> string -> int -> int -> int -> int -> unit = app6 (dlsym dlh "raylib_ImageDrawText") *)
(* val ImageDrawTextEx: UNKNOWN[Image *] -> UNKNOWN[Font] -> string -> raylib_vector2 -> real -> real -> int -> unit = app7 (dlsym dlh "raylib_ImageDrawTextEx") *)
...
(* val LoadTextureCubemap: raylib_image -> int -> UNKNOWN[TextureCubemap] = app2 (dlsym dlh "raylib_LoadTextureCubemap") *)
...
(* val UpdateTexture: raylib_texture -> UNKNOWN[const void *] -> unit = app2 (dlsym dlh "raylib_UpdateTexture") *)
(* val UpdateTextureRec: raylib_texture -> UNKNOWN[Rectangle] -> UNKNOWN[const void *] -> unit = app3 (dlsym dlh "raylib_UpdateTextureRec") *)
(* val GenTextureMipmaps: UNKNOWN[Texture2D *] -> unit = app1 (dlsym dlh "raylib_GenTextureMipmaps") *)
val SetTextureFilter: raylib_texture -> int -> unit = app2 (dlsym dlh "raylib_SetTextureFilter")
val SetTextureWrap: raylib_texture -> int -> unit = app2 (dlsym dlh "raylib_SetTextureWrap")
val DrawTexture: raylib_texture -> int -> int -> int -> unit = app4 (dlsym dlh "raylib_DrawTexture")
val DrawTextureV: raylib_texture -> raylib_vector2 -> int -> unit = app3 (dlsym dlh "raylib_DrawTextureV")
val DrawTextureEx: raylib_texture -> raylib_vector2 -> real -> real -> int -> unit = app5 (dlsym dlh "raylib_DrawTextureEx")
(* val DrawTextureRec: raylib_texture -> UNKNOWN[Rectangle] -> raylib_vector2 -> int -> unit = app4 (dlsym dlh "raylib_DrawTextureRec") *)
(* val DrawTexturePro: raylib_texture -> UNKNOWN[Rectangle] -> UNKNOWN[Rectangle] -> raylib_vector2 -> real -> int -> unit = app6 (dlsym dlh "raylib_DrawTexturePro") *)
(* val DrawTextureNPatch: raylib_texture -> UNKNOWN[NPatchInfo] -> UNKNOWN[Rectangle] -> raylib_vector2 -> real -> int -> unit = app6 (dlsym dlh "raylib_DrawTextureNPatch") *)
...
(* val LoadFontFromImage: raylib_image -> int -> int -> UNKNOWN[Font] = app3 (dlsym dlh "raylib_LoadFontFromImage") *)
...
(* val GenImageFontAtlas: UNKNOWN[const GlyphInfo *] -> UNKNOWN[Rectangle **] -> int -> int -> int -> int -> raylib_image = app6 (dlsym dlh "raylib_GenImageFontAtlas") *)
...
(* val DrawTextEx: UNKNOWN[Font] -> string -> raylib_vector2 -> real -> real -> int -> unit = app6 (dlsym dlh "raylib_DrawTextEx") *)
(* val DrawTextPro: UNKNOWN[Font] -> string -> raylib_vector2 -> raylib_vector2 -> real -> real -> real -> int -> unit = app8 (dlsym dlh "raylib_DrawTextPro") *)
(* val DrawTextCodepoint: UNKNOWN[Font] -> int -> raylib_vector2 -> real -> int -> unit = app5 (dlsym dlh "raylib_DrawTextCodepoint") *)
(* val DrawTextCodepoints: UNKNOWN[Font] -> UNKNOWN[const int *] -> int -> raylib_vector2 -> real -> real -> int -> unit = app7 (dlsym dlh "raylib_DrawTextCodepoints") *)
...
(* val MeasureTextEx: UNKNOWN[Font] -> string -> real -> real -> raylib_vector2 = app4 (dlsym dlh "raylib_MeasureTextEx") *)
...
(* val DrawPlane: UNKNOWN[Vector3] -> raylib_vector2 -> int -> unit = app3 (dlsym dlh "raylib_DrawPlane") *)
...
(* val DrawBillboard: UNKNOWN[Camera] -> raylib_texture -> UNKNOWN[Vector3] -> real -> int -> unit = app5 (dlsym dlh "raylib_DrawBillboard") *)
(* val DrawBillboardRec: UNKNOWN[Camera] -> raylib_texture -> UNKNOWN[Rectangle] -> UNKNOWN[Vector3] -> raylib_vector2 -> int -> unit = app6 (dlsym dlh "raylib_DrawBillboardRec") *)
(* val DrawBillboardPro: UNKNOWN[Camera] -> raylib_texture -> UNKNOWN[Rectangle] -> UNKNOWN[Vector3] -> UNKNOWN[Vector3] -> raylib_vector2 -> raylib_vector2 -> real -> int -> unit = app9 (dlsym dlh "raylib_DrawBillboardPro") *)
...
(* val GenMeshHeightmap: raylib_image -> UNKNOWN[Vector3] -> UNKNOWN[Mesh] = app2 (dlsym dlh "raylib_GenMeshHeightmap") *)
(* val GenMeshCubicmap: raylib_image -> UNKNOWN[Vector3] -> UNKNOWN[Mesh] = app2 (dlsym dlh "raylib_GenMeshCubicmap") *)
...
(* val SetMaterialTexture: UNKNOWN[Material *] -> int -> raylib_texture -> unit = app3 (dlsym dlh "raylib_SetMaterialTexture") *)
